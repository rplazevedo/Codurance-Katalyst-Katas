...
@pytest.mark.parametrize(
    "input_year,expected", [(1990, False), (1992, True), (1996, True), (2004, True)]
)
...
@pytest.mark.parametrize(
    "input_year,expected", [(1600, True), (1200, True), (2000, True)]
)
...
@pytest.mark.parametrize(
    "input_year,expected", [(1900, False), (1800, False), (1700, False)]
)

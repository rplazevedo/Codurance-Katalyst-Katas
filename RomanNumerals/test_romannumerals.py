...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(1, "I"), (2, "II"), (3, "III")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(6, "VI"), (7, "VII"), (8, "VIII")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(11, "XI"), (12, "XII"), (13, "XIII")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(15, "XV"), (16, "XVI"), (17, "XVII")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral",
    [(20, "XX"), (21, "XXI"), (23, "XXIII"), (24, "XXIV"), (25, "XXV"), (27, "XXVII")],
)
...
@pytest.mark.parametrize("input_number,expected_numeral", [(41, "XLI"), (42, "XLII")])
...
@pytest.mark.parametrize(
    "input_number,expected_numeral",
    [(44, "XLIV"), (45, "XLV"), (47, "XLVII"), (49, "XLIX")],
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral",
    [(50, "L"), (51, "LI"), (52, "LII"), (54, "LIV"), (56, "LVI"), (59, "LIX")],
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(200, "CC"), (299, "CCXCIX")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(400, "CD"), (408, "CDVIII"), (499, "CDXCIX")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(500, "D"), (501, "DI"), (502, "DII")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(900, "CM"), (999, "CMXCIX")]
)
...
@pytest.mark.parametrize(
    "input_number,expected_numeral", [(1000, "M"), (2008, "MMVIII"), (4000, "MMMM")]
)
